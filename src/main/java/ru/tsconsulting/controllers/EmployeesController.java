...
public class EmployeesController {
	...
	@ApiOperation(value = "Transfer employee from one department to another", response = Employee.class)
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Successful transfer of employee", response = Employee.class),
	...
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Successful deletion of employee", response = Employee.class),
	...
	@ApiOperation(value = "Create employee by id", response = Employee.class)
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Successful creation of employee", response = Employee.class),
			@ApiResponse(code = 500, message = "Internal server error")}
	)
	...
	@ApiOperation(value = "Return employee by id", response = Employee.class)
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Successful retrieval of employee", response = Employee.class),
			@ApiResponse(code = 404, message = "Employee with given id does not exist"),
			@ApiResponse(code = 500, message = "Internal server error")}
	)
	...
	@ApiOperation(value = "Return history of employee by id", response = Employee.class)
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Successful retrieval of the history of employee", response = Employee.class),
	...
	@ApiOperation(value = "Edit employee by id", response = Employee.class)
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Successful edition of employee", response = Employee.class),
			@ApiResponse(code = 404, message = "Employee with given id does not exist"),
			@ApiResponse(code = 500, message = "Internal server error")}
	)
